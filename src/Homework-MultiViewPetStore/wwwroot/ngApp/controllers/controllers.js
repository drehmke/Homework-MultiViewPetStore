...
(function (PetStoreApp) {
    ...
    (function (Controllers) {
        var Pet = (function () {
            function Pet(id, name, img, description, price, age) {
                this.id = id;
                this.name = name;
                this.img = img;
        ...
        var Dog = (function (_super) {
            ...
            function Dog(id, name, img, price, age, description) {
                _super.call(this, id, name, img, description, price, age);
            }
            return Dog;
        }(Pet));
        var Bunny = (function (_super) {
            __extends(Bunny, _super);
            function Bunny(id, name, img, price, age, description) {
                _super.call(this, id, name, img, description, price, age);
            }
            return Bunny;
        }(Pet));
        ...
        var DetailsController = (function () {
            function DetailsController($stateParams) {
                ...
                if ($stateParams["type"] == "dog") {
                    this.pet = dogs.filter(function (d) { return d.id == $stateParams["id"]; })[0];
                }
                else if ($stateParams["type"] == "bunny") {
                    this.pet = bunnies.filter(function (b) { return b.id == $stateParams["id"]; })[0];
                }
            }
            return DetailsController;
        }());
        Controllers.DetailsController = DetailsController;
    })(Controllers = PetStoreApp.Controllers || (PetStoreApp.Controllers = {}));
